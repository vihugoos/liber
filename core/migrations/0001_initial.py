    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_criado', models.DateField(auto_now_add=True, verbose_name='Data Criado')),
                ('hora_criado', models.TimeField(auto_now_add=True, verbose_name='Hora_Criado')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('Em aberto', 'Em aberto'), ('Em andamento', 'Em andamento'), ('Concluida', 'Concluida')], max_length=13, verbose_name='Status')),
                ('comprovante', models.FileField(blank=True, upload_to=core.models.get_file_path, verbose_name='Comprovante Serviço')),
